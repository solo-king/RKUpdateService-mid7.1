    	...
    	try {	    	
	    	...
	    	if(s[1].contains("@")) {
	    		...
	    		if(s4.length > 1) {
	    			...
	    			info.setRequestPath(s4[1].substring(s4[1].indexOf("/")+1));
	    		}else {
	    			info.setHost(s4[0].substring(0, s4[0].indexOf("/")));
	    			info.setRequestPath(s4[0].substring(s4[0].indexOf("/")+1));
	    		}
	    	}else {
	    		...
	    		if(str.length > 1) {
	    			...
	    			info.setRequestPath(str[1].substring(str[1].indexOf("/")+1));
	    		}else {
	    			info.setHost(str[0].substring(0, str[0].indexOf("/")));
	    			info.setRequestPath(str[0].substring(str[0].indexOf("/")+1));
	    		}
	    	}
    	}catch (Exception e) {
